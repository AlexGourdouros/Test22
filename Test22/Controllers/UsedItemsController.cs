...
namespace Test22.Controllers
{
    public class UsedItemsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "UsedID,ItemID,Quantity,UnitCost,ExtendedCost,DateUsed,UserID")] UsedItem usedItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "UsedID,ItemID,Quantity,UnitCost,ExtendedCost,DateUsed,UserID")] UsedItem usedItem)
        {
            if (ModelState.IsValid)
            {
