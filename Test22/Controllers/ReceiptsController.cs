...
namespace Test22.Controllers
{
    public class ReceiptsController : Controller
    {
        ...
        {
            ViewBag.InvoiceItemID = new SelectList(db.InvoiceItems, "InvoiceItemID", "InvoiceItemID");
        ...
        public ActionResult Create([Bind(Include = "ReceiptID,Quantity,Cost,TotalCost,ReceiptDate,InvoiceItemID,UserID")] Receipt receipt)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ReceiptID,Quantity,Cost,TotalCost,ReceiptDate,InvoiceItemID,UserID")] Receipt receipt)
        {
            if (ModelState.IsValid)
            {
